      ...
      {isAdmin && showForm && (
        <div className="card" style={{ marginBottom: 12 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
            ...
            <div className="field-group"><div className="field-label">Till datum *</div><input className="field" type="date" value={form.till_datum} min={form.fran_datum} onChange={e => setForm({ ...form, till_datum: e.target.value })} /></div>
          </div>
